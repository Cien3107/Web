...
class BrandProduct extends Controller
{
    ...
    public function save_brand_product(Request $request){
        ...
        $this->validate(request(),[
            'brand_product_name' =>'required|min:3|unique:tbl_brand,brand_name',
            'brand_product_desc' =>'required|min:6',

        ],[
            'brand_product_name.required' => 'Thương hiệu Không được để trống.',
            'brand_product_desc.required' => 'Mô tả Không được để trống.',
            'min' => 'Không ít hơn 6 kí tự.',
            'brand_product_name.unique' => 'Tên thương hiệu đã tồn tại.'
        ]);
    ...
    public function unactive_brand_product($brand_product_id){
    	...
    	Session::put('message','Không kích hoạt thương hiệu thành công.');
    ...
    public function active_brand_product($brand_product_id){
    	...
    	Session::put('message','Kích hoạt thương hiệu thành công.');
    	return Redirect::to('all-brand-product');
    }
