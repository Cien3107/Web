    ...
    text-transform: uppercase;font-weight: bolder;">
                        ...
                        <!-- <div class="range border-bottom py-2" style="height: 200px;padding: 0px;margin: 0px;">
                            ...
                            <div class="w3l-range" style="padding: 0px;margin: 0px;" >
                                <ul>
                                    <li><a href="?price=1">Dưới 1tr</a></li>
                                    <li><a href="?price=2">1.000.000 - 3.000.000</a></li>
                                    <li><a href="?price=3">3.000.000 - 5.000.000</a></li>
                                    <li><a href="?price=4">5.000.000 - 7.000.000</a></li>
                                    <li><a href="?price=5">Trên 7tr</a></li>
                                </ul>
                                <form>
                                    <div id="slider-range">
